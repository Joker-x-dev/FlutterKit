...
part of 'goods_network_data_source_impl.dart';
...
class _GoodsNetworkDataSourceImpl implements GoodsNetworkDataSourceImpl {
  _GoodsNetworkDataSourceImpl(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'goods/info';
  }
