...
class AnimationModel {
  ...
  const AnimationModel({required this.duration, this.curve = Curves.easeInOut});
}
...
class _InheritedAnimation extends InheritedWidget {
  ...
  /// [animation] 动画模型
  /// [child] 子 Widget
  const _InheritedAnimation({required this.animation, required super.child});
...
extension AnimationExtension on Widget {
  ...
  Widget animate(Duration duration, {Curve curve = Curves.easeInOut}) {
    return _InheritedAnimation(
      animation: AnimationModel(duration: duration, curve: curve),
      child: this,
    );
  }
