...
> TDesign Flutter 贡献指南

> 来源：[TDesign Flutter 官方文档](https://tdesign.tencent.com/flutter/develop)
> 归档时间：2026-07-16T07:37:59.655Z

1. [1. 项目地址](#_1-项目地址)
   1. [目录结构](#目录结构)
2. [2. 如何运行](#_2-如何运行)
   1. [2.1 Flutter 基础知识](#_2-1-flutter-基础知识)
   2. [2.2 开发环境要求](#_2-2-开发环境要求)
   3. [2.3 克隆项目](#_2-3-克隆项目)
   4. [2.4 运行 Flutter 项目](#_2-4-运行-flutter-项目)
   5. [2.5 Flutter 多版本兼容](#_2-5-flutter-多版本兼容)
   6. [2.6 运行前端官网项目](#_2-6-运行前端官网项目)
3. [3. 如何领取 Issue](#_3-如何领取-issue)
   1. [3.1 一个 Issue 的完整流程](#_3-1-一个-issue-的完整流程)
   2. [3.2 标签管理](#_3-2-标签管理)
4. [4. 开发规范](#_4-开发规范)
5. [5. 验收标准](#_5-验收标准)
   1. [5.1 PR 规则](#_5-1-pr-规则)
   2. [5.2 代码 Review 自检【欢迎大家补充】](#_5-2-代码-review-自检【欢迎大家补充】)
   3. [5.3 文档自检](#_5-3-文档自检)
   4. [5.4 Demo 自测](#_5-4-demo-自测)
   5. [5.5 视觉走查](#_5-5-视觉走查)
6. [6. 合并 PR](#_6-合并-pr)
...
- Flutter 基础介绍：<https://book.flutterchina.club/chapter1/flutter_intro.html>
- Dart 语言介绍：<https://book.flutterchina.club/chapter1/dart.html>
- 搭建 Flutter 开发环境：<https://book.flutterchina.club/chapter1/install_flutter.html>
