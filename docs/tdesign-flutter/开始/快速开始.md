...
> 来源：[TDesign Flutter 官方文档](https://tdesign.tencent.com/flutter/getting-started)
...
4. [📖 使用方法](#📖-使用方法)
   ...
   2. [图标](#图标)
5. [🎨 自定义主题](#🎨-自定义主题)
   1. [方式一：JSON 配置](#方式一：json-配置)
   2. [方式二：主题生成器（推荐）](#方式二：主题生成器（推荐）)
   3. [深色模式](#深色模式)
6. [🌍 国际化](#🌍-国际化)
   1. [快速配置](#快速配置)
7. [❓ 常见问题](#❓-常见问题)
...
[![License](https://img.shields.io/github/license/tencent/tdesign-flutter)](https://github.com/Tencent/tdesign-flutter/blob/main/LICENSE)
[![Version](https://img.shields.io/pub/v/tdesign_flutter)](https://pub.dev/packages/tdesign_flutter)
[![Downloads](https://img.shields.io/pub/dm/tdesign_flutter)](https://pub.dev/packages/tdesign_flutter/score)
[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/Tencent/tdesign-flutter)
...
![](https://tdesign.tencent.com/flutter/assets/qrcode/td_apk_qrcode_0_2_7.png)
...
> **注意**：[v0.2.6](<更新日志.md>) 版本开始，主题生成器已支持"深色模式"，具体可参考[深色模式](<../全局配置/深色模式.md>)。

[

](https://tdesign.gtimg.com/site/theme/demo-cn.mp4)
...
欢迎贡献代码！请在提交 [Pull Request](https://github.com/Tencent/tdesign-flutter/pulls) 前阅读[贡献指南](<贡献指南.md>)。

[![](https://contrib.rocks/image?repo=Tencent/tdesign-flutter)](https://github.com/Tencent/tdesign-flutter/graphs/contributors)

## 💬 交流反馈

创建 [GitHub Issues](https://github.com/Tencent/tdesign-flutter/issues) 或扫描二维码加入用户群：

![](https://tdesign.tencent.com/flutter/assets/qrcode/feedback.png)
...
TDesign Flutter 遵循 [MIT 协议](https://github.com/Tencent/tdesign-flutter/blob/main/LICENSE)。
